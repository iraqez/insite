...
class LoggingConnection(_connection):
    ...
    .. __: http://docs2.python.org/library/logging.html
    """
...
class UUID_adapter(object):
    ...
    .. __: http://docs2.python.org/library/uuid.html
    .. __: http://www.postgresql.org/docs2/current/static/datatype-uuid.html
    """
