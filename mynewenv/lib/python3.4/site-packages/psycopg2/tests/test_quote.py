...
class QuotingTestCase(ConnectingTestCase):
    ...
    http://www.postgresql.org/docs2/current/static/sql-syntax-lexical.html#SQL-SYNTAX-STRINGS
    http://www.postgresql.org/docs2/current/static/runtime-config-compatible.html
    """
