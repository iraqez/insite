...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='leading',
            name='subdivision',
            field=models.ManyToManyField(to='docs2.Subdivision', verbose_name='Підрозділ'),
        ),
        migrations.AddField(
            model_name='docsleading',
            name='leading',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='docs2.Leading'),
        ),
    ]
